...
**④ 你说的话被锁定。** 你写出口的话原样出现在舞台上，AI 只能补动作和微表情。
...
往事这块有一条容易被忽略的规则：**它只装他自己经历过的**。他没在场的那些轮次，引擎只给他留一行「第 2 轮 ~ 第 4 轮：你不在这里」——内容一个字都不给。别人的台词和动作也不会因为"引擎知道"就进他的记忆，他记得的只是他当时实际接收到的那一份。
