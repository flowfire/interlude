...
如果他在下指令 —— 「让导演安排一场雨」「希望接下来有人来找我」「这一轮别让他们说话」
「我想看到他们吵起来」—— 那整段算 **directive（指示）**，把他的话**原样**抄进 text。

**不要因为它里面提到了天气、地点、人物就判成 scene / action / worldfact**：
说的是"让导演安排一场雨"，重点不是雨，是"让……"这个动作。
判据很简单：**看主语是在世界里动，还是在对你动。**

  · 「天开始下雨了」→ scene（他描述世界）
  · 「让天下雨」→ directive（他要求引擎）
  · 「我希望他别走」→ inner（他角色的心理）
  · 「让他留下来」→ directive（是指示，不是角色的动作）

directive 只会送到导演手里，角色看不到它 —— 放心照抄，不必润色。
